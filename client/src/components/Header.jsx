      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between flex-1 gap-8 sm:justify-end">
            ...
            >
              ...
              <p className="hidden ml-2 text-xs text-left sm:block">
                <strong className="block font-medium">Abdiladif Rooble</strong>

                <span className="text-gray-500"> rooble10@fikrcamp.io </span>
              </p>
        ...
        <div className="mt-8">
          ...
          <p className="mt-1.5 text-sm text-gray-500">
            If you're hungry, you're not happy. We can help with that.
          </p>
        </div>
      </div>
    </header>
